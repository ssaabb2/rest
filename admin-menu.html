...
<script>
  ...
  window.SUPABASE_ANON = "sb_publishable_G6c_2_eG31NbIBMHpjOqRw_JTu2hmnO";               /* بدّلها */
</script>
...
<script type="module">
  ...
  <style>
    ...
    main > section#menu { display: block; }
...
<button class="icon-btn" id="notifyBtn" title="الإشعارات"
        aria-controls="notifDrawer" aria-expanded="false" type="button">
  ...
  <div class="admin-layout">
    ...
    <aside class="sidebar" aria-label="القائمة الجانبية">
      ...
      <a class="side-link" href="admin-menu.html" aria-current="page">إدارة المنيو</a>
    ...
    <main class="main" role="main">
      <!-- (محفوظة لتوافق السكربتات إن لزم، ستبقى مخفية) -->
      <section id="dashboard">
        <div class="kpis">
          ...
          <div class="kpi">
            <div class="small">طلبات في الانتظار</div>
        ...
        <div class="grid" style="grid-template-columns:1fr 1fr">
          <div class="card" style="padding:16px;min-height:260px">
            <h3>الأطباق الأكثر طلباً <span class="small">(هذا الأسبوع)</span></h3>
            <div id="topDishes" class="small" style="margin-top:10px;color:var(--muted)">لا يوجد بيانات بعد</div>
          </div>
          <div class="card" style="padding:16px;min-height:260px">
            <h3>مبيعات الأسبوع</h3>
            <div id="weekSales" class="small" style="margin-top:10px;color:var(--muted)">لا يوجد بيانات بعد</div>
          </div>
        </div>
        ...
        <div class="section card" style="padding:16px">
          ...
          <table class="table" id="ordersTable">
            <thead><tr><th>رقم الطلب</th><th>اسم الطلب</th><th>العدد</th><th>رقم الطاولة</th><th>الحالة</th><th>الإجمالي</th><th>الوقت</th><th>حذف</th></tr></thead>
            <tbody></tbody>
          </table>
        </div>
      </section>
      ...
      <section id="menu" class="section card" style="padding:16px">
        ...
        <form id="itemForm" class="form" autocomplete="off">
          ...
          <div style="display:flex;gap:10px">
            ...
            <span class="small" id="itemMsg" aria-live="polite"></span>
          </div>
        </form>
        ...
        <h3>قائمة الأطباق</h3>
        <table class="table" id="itemsTable" aria-label="قائمة الأطباق">
          <thead>
      ...
      <section id="cats" class="section card" style="padding:16px">
        ...
        <form id="catForm" class="form" style="max-width:520px">
          ...
          <div style="display:flex;gap:10px">
            ...
            <span class="small" id="catMsg" aria-live="polite"></span>
          </div>
        </form>

        <hr class="sep" />
        <h3>الأقسام</h3>
        <table class="table" id="catsTable" aria-label="الأقسام">
          <thead><tr><th>الاسم</th><th>عدد الأطباق</th><th>عمليات</th></tr></thead>
          <tbody></tbody>
        </table>
      </section>

      <!-- RATINGS (مخفية هنا – تُترك للتوافق فقط) -->
